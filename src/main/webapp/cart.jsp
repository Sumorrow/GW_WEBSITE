...
<table>
    欢迎,${user.username}
    <p>back to  <a href="/untitled1/mall.jsp">mall</a> now!</p>
...
<table border="1" cellspacing="0"width="800" >
    ...
    <c:forEach items="${cartList}" var="cart">
        <tr>
            ...
            <td><a href="/untitled1/selectcartServlet?id=${cart.id}&operation=1">修改 </a>
                <a href="/untitled1/selectcartServlet?id=${cart.id}&operation=2">删除 </a>
