...
<table>
    ...
    <c:if test="${user.username != 'admin'}">
        <p><a href="/untitled1_war/cartServlet">购物车</a></p>
        <a href="/untitled1_war/historyServlet?operation=2&usersid=${user.id}">用户查询购买记录</a>
    </c:if>

    <c:if test="${user.username == 'admin'}">
        <p><a href="/untitled1_war/historyServlet?operation=1">购买总记录</a></p>
        <a href="/untitled1_war/historyServlet?operation=3">商品销售记录</a>
    </c:if>
</p>
